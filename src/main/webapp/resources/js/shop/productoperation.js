...
$(function() {
	...
	var infoUrl = '/onlineshop/shopadmin/getproductbyid?productId=' + productId;
	// 获取当前店铺设定的商品类别列表的url
	var categoryUrl = '/onlineshop/shopadmin/getproductcategorylist';
	// 更新商品信息的url
	var productPostUrl = '/onlineshop/shopadmin/modifyproduct';
	// 由于商品添加和编辑使用的是同一页面
	// 标识是添加还是编辑操作
	var isEdit = false;
	if (productId) {
		...
		getCategory();
		productPostUrl = '/onlineshop/shopadmin/addproduct';
	}
